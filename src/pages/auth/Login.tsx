      ...
      <Card className="w-full max-w-lg glass-card border-white/20 hover-lift relative z-10 rounded-3xl">
        <CardHeader className="text-center p-8">
          <div className="flex justify-center mb-6">
            <div className="p-4 bg-gradient-to-r from-destructive to-red-600 rounded-2xl">
              <Shield className="h-8 w-8 text-white" />
            </div>
          </div>
          <CardTitle className="text-3xl font-bold mb-2 text-destructive">Admin Login</CardTitle>
          <CardDescription className="text-base">Platform management and administration</CardDescription>
        </CardHeader>
        ...
        <CardContent className="p-8 pt-0">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Button type="submit" variant="hero" size="lg" className="w-full h-12 rounded-xl font-semibold bg-gradient-to-r from-destructive to-red-600 hover:from-destructive/90 hover:to-red-600/90" disabled={isLoading}>
        ...
        <CardFooter className="flex flex-col space-y-4 p-8 pt-0">
          <p className="text-sm text-muted-foreground text-center">
            Access other login pages
          </p>
          <div className="flex flex-col gap-2 w-full">
            <Link to="/login/customer" className="w-full">
              <Button variant="glass" size="sm" className="w-full">Customer Login</Button>
            </Link>
            <Link to="/login/delivery" className="w-full">
              <Button variant="glass" size="sm" className="w-full">Delivery Login</Button>
            </Link>
            <Link to="/login/restaurant" className="w-full">
              <Button variant="glass" size="sm" className="w-full">Restaurant Login</Button>
            </Link>
          </div>
        </CardFooter>
      </Card>
